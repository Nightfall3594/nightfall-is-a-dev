...
export default function Other() {
    return (
        <section className="other">
            ...
            <div className="other-header__container">
                <h1 className="other-header__title">About</h1>
                <h2 className="other-header__subtitle">Information about the little why's and how's</h2>
            </div>
            ...
            <p className={"about__content"}>
                ...
                I also learned how to use React and related libraries. <br/><br/>
